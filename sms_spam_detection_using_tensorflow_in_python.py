# -*- coding: utf-8 -*-
"""SMS_Spam_Detection_using_TensorFlow_in_Python (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1oOj6M4BrZV5ju2-C-02876E2UE1-ts5W
"""
...
def fit_model(model, epochs, X_train=X_train, y_train=y_train,
  ...
  # Check if validation data is provided
  if X_test is not None and y_test is not None:
      history = model.fit(X_train.to_numpy(), # Changed to convert X_train to numpy before using it.
                      y_train,
                      epochs=epochs,
                      validation_data=(X_test.to_numpy(), y_test)) # Changed to convert X_test to numpy as well. #Removed validation steps argument
  else:
      # Handle case where validation data is not provided
      history = model.fit(X_train.to_numpy(), # Changed to convert X_train to numpy.
                      y_train,
                      epochs=epochs)
  return history
